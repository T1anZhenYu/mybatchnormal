...
class DetachClipL2(nn.BatchNorm2d):
    def __init__(self, num_features, eps=0.01, momentum=0.1,
                 affine=True, track_running_stats=True):
        super(DetachClipL2, self).__init__(
    ...
    def forward(self, input):
        ...
        if self.training:
            ...
            var = (input).pow(2).mean(dim=(0,2, 3), keepdim=True)
...
class VGG_DetachClipL2(nn.Module):
    def __init__(self, vgg_name):
        super(VGG_DetachClipL2, self).__init__()
